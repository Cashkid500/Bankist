...
const account3 = {
  owner: 'Oyewole Ayobami',
  movements: [20000, -2000, 3400, -300, -200, 5000, 4000, -4600],
  interestRate: 0.7,
  pin: 3333,
...
const account4 = {
  owner: 'Olowe Taiwo',
  movements: [4300, 10000, -7000, -5000, 1000, -7000, 15500, 20000],
  interestRate: 1,
  pin: 4444,
